                ...
                <div className="add-right">
                    ...
                    <div className="console-new">
                        <div className="device">
                            <label type="radio" name="devicee">Console:<br/>
                            <input type="radio" name="devicee"/>PC<br/>
                            <input type="radio" name="devicee"/>PSN<br/>
                            <input type="radio" name="devicee"/>XBOX</label>
                        </div>
                        <div className="new">
